...
ROOT_URLCONF = 'aNovel_approach_forCredit_cardfraudDetection.urls'
...
WSGI_APPLICATION = 'aNovel_approach_forCredit_cardfraudDetection.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'aNovel_approach_forCredit_cardfraudDetection',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
