"""aNovel_approach_forCredit_cardfraudDetection URL Configuration
...
from aNovel_approach_forCredit_cardfraudDetection import settings
...
urlpatterns = [
    ...
    url(r'^Credit_Card_FraudPrediction_RatioDetails/$', remoteuser.Credit_Card_FraudPrediction_RatioDetails, name="Credit_Card_FraudPrediction_RatioDetails"),
    ...
    url(r'^Find_CreditCard_ResultsDetails/$', serviceprovider.Find_CreditCard_ResultsDetails, name="Find_CreditCard_ResultsDetails"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_DetectedCredit_CardFraudDetails/$', serviceprovider.View_DetectedCredit_CardFraudDetails, name="View_DetectedCredit_CardFraudDetails"),
